<%@page import="com.cts.couriertrackingsystem.entity.PackageEntity"%>
...
<center>
	<body class="bg-dark" style="font-family: Hack;">
		...
		<sql:query var="rec" dataSource="${db}"> SELECT * from package WHERE customer_id = <%=id%>; </sql:query>
